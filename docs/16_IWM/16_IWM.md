...
![Equity](Reports/docs/16_IWM/images/graph2.png) 

![Drawdown](Reports/docs/16_IWM/images/graph3.png)

![Daily](Reports/docs/16_IWM/images/graph5.png) 

![Monthly](Reports/docs/16_IWM/images/graph7.png) <div style="page-break-after: always;"></div> 
### Trade Plots 

![Individual %Gains](Reports/docs/16_IWM/images/plot0.png) 

![Distribution of %Gains](Reports/docs/16_IWM/images/plot1.png)

![Distribution of %Excursions](Reports/docs/16_IWM/images/plot2.png) 
...
![MCPT Profit](Reports/docs/16_IWM/images/plot4.png) 

![MCPT Excursion](Reports/docs/16_IWM/images/plot5.png)
